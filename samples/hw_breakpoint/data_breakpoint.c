...
static char ksym_name[KSYM_NAME_LEN] = "nr_threads";
module_param_string(ksym, ksym_name, KSYM_NAME_LEN, S_IRUGO);
MODULE_PARM_DESC(ksym, "GPL-only Kernel symbol to monitor; this module will"
		       "report any write operations on the kernel symbol");
